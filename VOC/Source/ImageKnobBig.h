...
public:
    ImageKnobBig()
    {
        auto imageData = BinaryData::knobBig_png;  // Sostituisci con il nome reale del file
        auto imageSize = BinaryData::knobBig_pngSize;  // Sostituisci con il nome reale del file
        ...
        auto maxDimension = 100;  // Usa una dimensione che si adatti bene al tuo componente
