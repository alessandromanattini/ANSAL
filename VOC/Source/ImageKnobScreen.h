...
public:
    ImageKnobScreen()
    {
        auto imageData = BinaryData::screenKnob_png;  // Replace with the actual file name
        auto imageSize = BinaryData::screenKnob_pngSize;  // Replace with the actual file name
